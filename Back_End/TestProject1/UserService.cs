...
namespace YourNamespace.Tests
{
    ...
    public class UserServiceTests
    {
        ...
        public void GetTurfList_ShouldReturnListOfTurfs()
        {
            ...
            Assert.Equals(expectedTurfs.Count, result.Count); // Verify the count matches
            Assert.Equals(expectedTurfs[0].TurfId, result[0].TurfId); // Verify TurfId for the first turf
            Assert.Equals(expectedTurfs[1].Name, result[1].Name); // Verify Name for the second turf
